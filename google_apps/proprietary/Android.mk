...
LOCAL_SRC_FILES := system/app/GoogleChrome/GoogleChrome.apk
LOCAL_MODULE_PATH := $(TARGET_OUT_APPS)
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_OWNER := google_apps
LOCAL_MODULE_TAGS := optional
...
LOCAL_SRC_FILES := system/app/GoogleMusic/GoogleMusic.apk
LOCAL_MODULE_PATH := $(TARGET_OUT_APPS)
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_OWNER := google_apps
LOCAL_MODULE_TAGS := optional
...
LOCAL_SRC_FILES := system/app/GooglePhotos/GooglePhotos.apk
LOCAL_MODULE_PATH := $(TARGET_OUT_APPS)
LOCAL_MODULE_CLASS := APPS
LOCAL_MODULE_OWNER := google_apps
LOCAL_MODULE_TAGS := optional
